...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.getTextItem().setText("\"Tomorrow is \n the first blank page\n"
				+ "of a 365 page book. \n Write a good one!\" \n Brad Paisley");
		...
		content.add( this.makeToolbar(), BorderLayout.NORTH );
	...
	private class ChooseBackgroundAction extends AbstractAction {
		...
		ChooseBackgroundAction(String text) {
			...
			if (text.equals("Color...")) {
				...
				g.fillRect(0,(32/5),32,(32/5)+5);
				g.setColor(Color.YELLOW);
				g.fillRect(0,(32/5)+5,32,(32/5)+10);
				g.setColor(Color.GREEN);
				g.fillRect(0,(32/5)+10,32,(32/5)+15);
				g.setColor(Color.BLUE);
				g.fillRect(0,(32/5)+15,32,(32/5)+20);
				g.setColor(Color.MAGENTA);
				g.fillRect(0,(32/5)+20,32,(32/5)+25);
				g.dispose();
