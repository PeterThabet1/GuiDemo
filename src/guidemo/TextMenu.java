...
public class TextMenu extends JMenu {
	...
	private JRadioButtonMenuItem left = new JRadioButtonMenuItem("Left");
	private JRadioButtonMenuItem right= new JRadioButtonMenuItem("Right");
	private JRadioButtonMenuItem center= new JRadioButtonMenuItem("Center");
	...
	private JMenu makeJustifyMenu() {
		JMenu Justify = new JMenu("Justify Text");
		...
		btngrp.add(this.left);
		btngrp.add(this.right);
		btngrp.add(this.center);

		Justify.add(this.left);
		Justify.add(this.right);
		Justify.add(this.center);
